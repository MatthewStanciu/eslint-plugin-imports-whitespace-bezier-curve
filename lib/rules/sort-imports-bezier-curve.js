  ...
  create: function (context) {
    return {
      Program: function (node) {
        ...
        // const controlPoints = [
        //   0,
        //   Math.min(...importLengths),
        //   calculatePercentile(importLengths, 25),
        //   calculatePercentile(importLengths, 75),
        //   calculatePercentile(importLengths, 75),
        //   calculatePercentile(importLengths, 25),
        //   Math.max(...importLengths),
        //   Math.max(...importLengths),
        // ];
        ...
        const curve = new Bezier(0, ...controlPoints);
