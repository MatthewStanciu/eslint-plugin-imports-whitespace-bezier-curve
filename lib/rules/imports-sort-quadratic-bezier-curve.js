...
module.exports = {
  meta: {
    type: "layout",
    docs: {
      description: "Sort imports along a quadratic bezier curve",
  ...
  create: function (context) {
    return {
      Program: function (_node) {
        ...
        const curve = new Bezier(0, 0, 12.5, 25, 25, 0);
        ...
        if (discrepancyFound) {
          ...
          context.report({
            ...
            message:
              "Whitespace before your imports must follow a quadratic bell-like Bezier curve.",
            fix: (fixer) => {
